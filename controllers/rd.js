        ...
        switch (Domain) {
            case "coding":
                ...
                if (Event === 'byte-bash') {
                    ...
                    const gid1Exists = await coding.findOne({
                        $or: [{ $and: [{ gid1: req.body.gid1 }, { Event: req.body.Event }] }, { $and: [{ gid2: req.body.gid1 }, { Event: req.body.Event }] }, { $and: [{ gid3: req.body.gid1 }, { Event: req.body.Event }] }]
                    });
                    const gid2Exists = await coding.findOne({
                        $or: [{ $and: [{ gid1: req.body.gid2 }, { Event: req.body.Event }] }, { $and: [{ gid2: req.body.gid2 }, { Event: req.body.Event }] }, { $and: [{ gid3: req.body.gid2 }, { Event: req.body.Event }] }]
                    });
                    const gid3Exists = await coding.findOne({
                        $or: [{ $and: [{ gid1: req.body.gid3 }, { Event: req.body.Event }] }, { $and: [{ gid2: req.body.gid3 }, { Event: req.body.Event }] }, { $and: [{ gid3: req.body.gid3 }, { Event: req.body.Event }] }]
                    });
                    if (gid1Exists && gid2Exists && gid3Exists) {
            ...
            case "civil":
                ...
                if (Event === 'mega-arch') {
                    ...
                    const gid1Exists = await civil.findOne({
                        $or: [{ $and: [{ gid1: req.body.gid1 }, { Event: req.body.Event }] }]
                    });
                    if (gid1Exists && gid2Exists && gid3Exists) {
