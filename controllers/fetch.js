...
const {coding,civil,robotics,gaming,electrical}=require('../db/rData');
...
module.exports = {fetch_coding,fetch_mrd,fetch_civil,fetch_electrical,fetch_gaming,fetch_robotics};